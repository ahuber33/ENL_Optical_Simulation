/// ENLOpticalSimMaterials.hh
//// Auteur: Arnaud HUBER for ENL group <huber@cenbg.in2p3.fr>
//// Copyright: 2022 (C) Projet RATP - ENL [LP2IB] - CELIA

// This class is used to create a plastic scintillator.

#ifndef ENLOpticalSimMaterials_h
#define ENLOpticalSimMaterials_h
...
public:
  ...
  ENLOpticalSimMaterials(G4String prop_buildfile);
  ~ENLOpticalSimMaterials();
  void Construct();
