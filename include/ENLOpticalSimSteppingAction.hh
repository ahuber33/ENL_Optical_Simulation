...
#ifndef ENLOpticalSimSteppingAction_h
#define ENLOpticalSimSteppingAction_h
...
class ENLOpticalSimSteppingAction : public G4UserSteppingAction
{
public:
  ENLOpticalSimSteppingAction();
  ~ENLOpticalSimSteppingAction();
public:
