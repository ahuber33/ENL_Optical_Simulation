...
const G4String ENLOpticalSimGeometry::path_bin = "../bin/";
const G4String ENLOpticalSimGeometry::path = "../simulation_input_files/";

// Constructor
ENLOpticalSimGeometry::ENLOpticalSimGeometry(){}
...
G4VPhysicalVolume* ENLOpticalSimGeometry::Construct( ){
  // Initialize scint classes
  scintProp = new ENLOpticalSimMaterials(path_bin+"Materials.cfg");
  ...
  theScint = new Scintillator(path_bin+"ENLOpticalSim.cfg");
