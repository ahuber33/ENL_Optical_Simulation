...
const G4String ENLOpticalSimMaterials::path = "../simulation_input_files/";
...
ENLOpticalSimMaterials::ENLOpticalSimMaterials(G4String prop_buildfile):bs_glass(0),
polysty(0),
Ti02(0),
coating(0),
scintillator(0),
...
ENLOpticalSimMaterials::~ENLOpticalSimMaterials()
{
...
void ENLOpticalSimMaterials::Construct()
{
...
G4Material* ENLOpticalSimMaterials::GetMaterial(G4String material)
{
